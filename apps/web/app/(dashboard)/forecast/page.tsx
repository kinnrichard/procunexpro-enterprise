            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b bg-muted/50 text-muted-foreground">
                  ...
                  <th className="text-right px-4 py-2.5 font-medium">Can Build Now</th>
                  <th className="text-left px-4 py-2.5 font-medium">Limiting Material</th>
                  <th className="text-left px-4 py-2.5 font-medium">Bottleneck detail</th>
                  ...
                  return (
                    <tr key={r.productId} className="hover:bg-accent/30 transition-colors">
                      ...
                      <td className="px-4 py-2.5 text-right">
                        <span className={cn('text-lg font-semibold tabular-nums', r.maxBuildable > 0 ? 'text-green-600' : 'text-red-600')}>{r.maxBuildable}</span>
