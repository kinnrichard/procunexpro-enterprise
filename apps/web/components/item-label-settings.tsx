      ...
      <CardHeader>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <CardDescription>QR opens the item page when scanned by a phone; Barcode encodes the SKU for handheld scanners. Stock lots use the lot number.</CardDescription>
          </div>
        </div>
      </CardHeader>
      <CardContent>
